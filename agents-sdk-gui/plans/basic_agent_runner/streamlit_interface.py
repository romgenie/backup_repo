...
class StreamlitInterface:
    ...
    def run(self):
        ...
        callbacks = {
            ...
            "handle_mcp_server_add": lambda server_id, config: handle_mcp_server_add(self.app, server_id, config),
            "handle_mcp_server_remove": lambda server_id: handle_mcp_server_remove(self.app, server_id),
            "handle_mcp_server_test": lambda config: handle_mcp_server_test(self.app, config),
