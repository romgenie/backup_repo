...
class AgentRunnerApp:
    ...
    def run(self):
        ...
        with mcp_tab:
            # Render the MCP tab
            render_mcp_tab(
                on_server_add=lambda server_id, config: on_mcp_server_add(self, server_id, config),
                on_server_remove=lambda server_id: on_mcp_server_remove(self, server_id),
                on_server_test=lambda config: on_mcp_server_test(self, config),
