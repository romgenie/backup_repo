...
class AgentRunnerApp:
    def __init__(self):
        ...
        # Ensure conversation_history exists (debugging)
        if "conversation_history" not in st.session_state:
            st.session_state.conversation_history = []
            print("WARNING: Had to manually initialize conversation_history")
    ...
    def _on_agent_create(self, agent, run_config):
        ...
        # Ensure conversation is initialized when agent is created
        if "conversation_history" not in st.session_state or not isinstance(st.session_state.conversation_history, list):
            init_conversation()
            print("Re-initializing conversation after agent creation")
