...
async def ensure_vector_store_exists(
    store_name: str = "ACME_Shop_Product_Knowledge",
    ...
    if not force_create and VECTOR_STORE_ID and VECTOR_STORE_ID != "your_vector_store_id_here":
    ...
    if not force_create:
        # If we're not forcing creation and no ID exists, return None
...
async def upload_knowledge_files(
    vector_store_id: str,
    knowledge_dir: str = "/Users/timgregg/Desktop/personal_assistants/src/data/knowledge"
) -> List[Dict[str, Any]]:
    """
