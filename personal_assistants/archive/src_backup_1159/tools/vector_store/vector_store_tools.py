...
def refresh_vector_store_cache() -> Dict[str, Any]:
    ...
    """
    # Use the manual refresh function to avoid function calling issues
    from src.utils.vector_store_cache import refresh_cache_manually
    return refresh_cache_manually()
